...
void part_imp_match_init_strict( double *imp, int clus1, int clus2, int lgth1, int lgth2, char **seq1, char **seq2, double *eff1, double *eff2, double *eff1_kozo, double *eff2_kozo, LocalHom ***localhom, int forscore )
{
...
void part_imp_match_init( double *imp, int clus1, int clus2, int lgth1, int lgth2, char **seq1, char **seq2, double *eff1, double *eff2, LocalHom ***localhom )
{
...
//			fprintf( stderr, "## Not allocated\n" );
	...
	if( c<maxdistclass ) reporterr( "Found a complex grouping. Use an ultrametric tree to make the calculation faster.\n" );
