		...
		switch( alg )
		{
			...
			case( 'A' ):
				if( clus1 == 1 && clus2 == 1 )
					...
					A__align( n_dynamicmtx, tmpres1, tmpres2, eff1, eff2, clus1, clus2, alloclen, NULL, &dumdb, NULL, NULL, NULL, NULL, NULL, 0, NULL, headgp, tailgp );
				break;
			default:
			...
			case( 'A' ):
				...
				else
				{
					if( scoringmatrices ) // called by tditeration.c
					{
						...
						totalscore += A__align( n_dynamicmtx, tmpres1, tmpres2, eff1, eff2, clus1, clus2, alloclen, NULL, &dumdb, sgap1, sgap2, egap1, egap2, chudanpt, chudanref, chudanres, headgp, tailgp );
				}
				break;
			default:
				fprintf( stderr, "alg = %c\n", alg );
