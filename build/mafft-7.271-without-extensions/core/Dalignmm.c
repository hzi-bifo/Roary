...
void imp_match_init_strictD( double *imp, int clus1, int clus2, int lgth1, int lgth2, char **seq1, char **seq2, double *eff1, double *eff2, double *eff1_kozo, double *eff2_kozo, LocalHom ***localhom, int forscore )
{
...
#if 0
//	if( clus1 == 1 && clus2 == 1 )
	reporterr( "In imp_match_init_strictD(), clus1=%d, clus2=%d\n", clus1, clus2 );
	{
